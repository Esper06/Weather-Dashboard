...
function generateEndpoint(city) { //this function makes a url from the api to be used. The city and number of days bits are variables
    ...
    var city = "Birmingham" //here as a test remember to remove

    endpoint = `https://api.openweathermap.org/data/2.5/forecast/daily?q=${city}&cnt=${NUMBER_OF_DAYS_TO_REQUEST}&appid=aa891061c4eb5441b7aab33d1b619398&units=metric`
}
